...
<main class="container-fluid">
    <section class="intro row">
        <article class="col-12 col-sm-6">
            ...
            <div>
                <a href="#" target="_blank"><button><i class="fab fa-whatsapp"></i>Acesse para orçarmos</button></a>
                <a href="<?php the_field('curriculo'); ?>" target="_blank">Meu Currículo</a>
            </div>
        </article>
        <div class="col-6 d-none d-md-flex side">
    ...
    <section class="row topo" id="estudio">
        <article class="d-flex align-items-center col-12 col-lg-8" id="lateral">
    ...
    <section class="interessado w-100">
        <h4>Ficou interessado? Me chame no Whatsapp, não perca tempo!</h4>
        <a href="#"><button><i class="fab fa-whatsapp"></i>Orçar locução</button></a>
    </section>
    <section id="sobre" class="d-flex" style="gap: 2rem;">
            <img src="http://rubenschammasvoz.com.br/wp-content/uploads/2023/01/rubinho.png" class="rubinho" alt="">
        <aside>
            <h2>Sobre mim</h2>
            <article>
                <?php the_field('sobre'); ?>
